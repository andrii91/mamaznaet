...
$('.area-item').addClass("hidden_animation").viewportChecker({
        classToAdd: 'visible animated fadeInDown', // Class to add to the elements when they are visible
        classToRemove: 'hidden_animation', 
        offset: 0    
    });
  
  $('.area-title:not(.right), .format-item:not(.right)').addClass("hidden_animation").viewportChecker({
        classToAdd: 'visible animated fadeInLeft', // Class to add to the elements when they are visible
        classToRemove: 'hidden_animation', 
        offset: 0    
    });
  
  $('.area-title.right, .format-item.right').addClass("hidden_animation").viewportChecker({
  ...
  function timer() {
    ...
    var end = new Date(2019, 8, 20, 0, 0, 0, 0);
